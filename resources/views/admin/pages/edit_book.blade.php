          ...
          <div class="table-responsive p-0">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    @endif
                    <form action="{{ url('/store-book-update/'.$book->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-9">
                            <div class="form-group">
                                <label for="book-name" class="form-control-label">Book Name</label>
                                <input class="form-control" type="text" onkeyup="ChangeToSlug()" name="book-name" id="slug" value="{{ $book->book_name }}">
                            </div>
                        </div>
                        {{-- <div class="col-md-9">
                            <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" type="text" name="book-desc" id="" >{{ $book->book_desc }}</textarea>
                            </div>
                        </div>
                        {{-- <div class="col-md-9">
                            <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="book-slug" id="convert_slug" value="{{ $book->book_slug }}">
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="form-group">
